        ...
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                className="w-full rounded-md border border-border bg-secondary px-3 py-2 font-mono text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
                defaultValue="https://api.keyvault.io"
              />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <input
                type="number"
                className="w-20 rounded-md border border-border bg-secondary px-3 py-2 text-center text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
                defaultValue={5}
              />
            </div>
            <div className="flex items-center justify-between">
